...
class Dependency:
    ...
    def postprocess_ninja_build(self, ninja_build_path: str) -> None:
        """
        Allows some dependencies to post-process the ninja.build file generated by CMake.
        """
        if not os.path.exists(ninja_build_path):
            raise IOError("File does not exist: %s", os.path.abspath(ninja_build_path))
